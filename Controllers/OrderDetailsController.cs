...
namespace WebApplication1.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Price,Quantity,OrderId,ProductId")] OrderDetail orderDetail)
        {
            ...
            ViewData["OrderId"] = new SelectList(_context.Orders, "Id", "CustomerAddress", orderDetail.OrderId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Price,Quantity,OrderId,ProductId")] OrderDetail orderDetail)
        {
